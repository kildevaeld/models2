...
class Expression {
    ...
    static createEnumType(position, args) {
        return new EnumTypeExpression(position, args[0], args[1]);
    }
    static createEnumMember(position, args) {
...
class EnumTypeExpression extends Expression {
    constructor(position, name, members) {
        super();
        this.position = position;
        this.name = name;
        this.members = members;
        this.nodeType = tokens_1.Token.EnumType;
    }
}
exports.EnumTypeExpression = EnumTypeExpression;
class EnumMemberExpression extends Expression {
    constructor(position, name, value) {
        ...
        this.name = name;
        this.value = value;
        this.nodeType = tokens_1.Token.EnumMember;
    }
}
exports.EnumMemberExpression = EnumMemberExpression;
function createExpression(type, position, ...args) {
    switch (type) {
        ...
        case tokens_1.Token.EnumType: return Expression.createEnumType(position, args);
        case tokens_1.Token.EnumMember: return Expression.createEnumMember(position, args);
