    ...
    generate(generator, options, files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let entry of map) {
                ...
                ast = yield this.preprocessor.parse(ast, Object.assign({ fileName: entry.name }, desc.options));
                let result = yield desc.run(ast, { split: options.split, file: Path.basename(entry.name, '.record') + desc.extname });
                out.push(...result);
